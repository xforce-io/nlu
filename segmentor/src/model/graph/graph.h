...
class Graph {
 ...
 public:
  ...
  void Process(OUT Offsets &offset, OUT NameEntities &nameEntities);
  void Profile(OUT Offsets &offset, OUT NameEntities &nameEntities);
 ...
 private: 
  ...
  void MakeResults_(OUT Offsets &offsets, OUT NameEntities &nameEntities);
